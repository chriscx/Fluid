...
describe 'app', ->
  ...
  it 'should get index page', (next) ->
    request 'http://localhost:' + config.port + '/', (err, res, body) ->
      res.statusCode.should.be.eql 200
      next()

  it 'should get login page', (next) ->
    request 'http://localhost:' + config.port + '/login', (err, res, body) ->
      res.statusCode.should.be.eql 200
      next()

  it 'should get signup page', (next) ->
    request 'http://localhost:' + config.port + '/signup', (err, res, body) ->
      res.statusCode.should.be.eql 200
      next()

  it 'should get logout page', (next) ->
    request 'http://localhost:' + config.port + '/logout', (err, res, body) ->
      res.statusCode.should.be.eql 200
      next()
  it 'should get index page', (next) ->
