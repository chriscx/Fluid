...
angular.module('Admin').controller('AdminSettingsController', function($scope, $http, $routeParams, $location, $window, MenuService, SettingsService) {
  var err;
  $scope.categoryList = [];
  $scope.menuList = [];
  $scope.newMenu = {
...
angular.module('Auth').controller('AuthController', function($scope, $http, $routeParams, $location, $window, UserService, AuthenticationService, MenuService) {
  $scope.alerts = [];
  $scope.user = {};
...
angular.module('Index').controller('IndexController', function($scope, $routeParams, $location, $window, $sce, UserService, AuthenticationService, MenuService, PageService, SettingsService) {
  $scope.site = {
    title: 'Fluid',
    header: '',
    footer: ''
...
angular.module('Auth').controller('LogoutController', function($scope, $routeParams, $location, $window, UserService, AuthenticationService) {
...
angular.module('Site').controller('PageController', function($scope, $http, $routeParams, $location, $window, $sce, PageService, MenuService) {
  $scope.page = {};
  if ($location.path() === '/') {
...
angular.module('Users').controller('UserController', function($scope, $http, $routeParams, $location, $window, UserService, AuthenticationService, MenuService) {
  return $scope.update = function(user) {
...
angular.module('Users').factory('File', function($http, $location, $window) {
  var File;
